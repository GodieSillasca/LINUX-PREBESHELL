...
#Aquí se muetsran los comandos que el usuario puede utilizar para la gran variedad de opciones de esta PREBESHELL creada por CAMD y SOMH.
echo ""
echo -e "		\e[101m**********************************\e[0m"
echo -e "		\e[101m**************AYUDA***************\e[0m"
echo -e "		\e[101m**********************************\e[0m"
echo ""
echo -e "\e[43mEsta shell tiene diversas opciones a las cuales puedes llamar mediante:\e[0m"
echo ""
echo -e "\e[32m'hora'\e[0m ----------Imprime en pantalla la hora del sistema."
echo -e "\e[33m'salir'\e[0m ---------Sale del presente script, de la PREBESHEEL de Any y Diego."
...
echo -e "\e[32m'creditos'\e[0m --------Imprime en pantalla los datos de los autores."
